...
from service.memory.base.contracts import PreparedExtractContext, ResolvedMemoryOperation
...
def _merge_fields(*, operation: ResolvedMemoryOperation, current_metadata: dict[str, Any]) -> dict[str, Any]:
    merged: dict[str, Any] = {}
    field_names = set(operation.field_merge_ops) | set(operation.fields)
