...
from runtime.memory.base.contracts import ArchivedSourceRef, MemorySourceRef, PreparedExtractContext
...
class ExtractContextRuntime:
    ...
    def prepare(
        ...
        *,
        ...
        return PreparedExtractContext.model_validate(
            cls.prepare_extract_context(
                task_id=task_id,
    ...
    def prepare_extract_context(
        ...
        *,
        ...
        agent_id: str | None,
        project_id: str | None,
        phase: str | MemoryTaskPhase = MemoryTaskPhase.PREPARE_EXTRACT_CONTEXT,
    ) -> dict:
        normalized = SourceMaterialNormalizer(trigger_type, archive_ref).normalize()
        ...
        prepared = PreparedExtractContext(
            ...
            user_id=normalized.user_id or user_id,
            agent_id=normalized.agent_id or agent_id,
            project_id=normalized.project_id or project_id,
