...
class LLMTransformation:
    ...
    @classmethod
    def setup_model_parameters(cls, model_params:dict[str,Any], prompt_messages: Union[ChatCompletionRequest, CompletionRequest], ):
    ...
    def transform_message(
        ...
        """
        llm_result = cls._transform_message(prompt_messages, credentials, raw_request, stream)
        if prompt_messages.tools:
            return cls._call_tools(prompt_messages,credentials, raw_request, llm_result)
        return llm_result

    @classmethod
    def _call_tools(cls, req: Union[ChatCompletionRequest, CompletionRequest],
                   credentials: dict,
                   raw_request: Request,
        ...
        if llm_result.message.tool_calls and len(llm_result.message.tool_calls) > 0:
            ...
            llm_result = cls._transform_message(prompt_messages=req,
